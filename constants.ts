...
export const PERSONAL_INFO = {
  ...
  summary:
    'Frontend specialist with 8+ years building high-performance, scalable UI systems using React, Next.js, and TypeScript. Expert in large-scale migrations, performance tuning, accessibility, and CI/CD automation.',
};
...
export const EXPERIENCES: ExperienceItem[] = [
  ...
  },
  {
    ...
    period: '2020 – 2021',
    description: ['UI-focused development in Agile sprints.', 'Built E2E automation for authorization portal.'],
  },
  {
    id: 'walmart',
    ...
    role: 'Software Engineer',
    period: '2017 – 2020',
    description: ['Built CMS tools and dashboards for internal health systems.'],
  },
];
