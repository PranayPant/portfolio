...
export const ProjectCard: React.FC<ProjectCardProps> = ({ project, index }) => {
  const getIcon = (id: string) => {
    switch(id) {
      case 'legacy-migration': return <Zap size={24} className="text-amber-500" />;
      case 'design-system': return <Layers size={24} className="text-purple-500" />;
      case 'automation-suite': return <BarChart size={24} className="text-emerald-500" />;
